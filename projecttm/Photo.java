...
public class Photo extends CommonData{
    ...
    public Photo(String s,String name, String description, int day, int month, int year,int day1, int month1, int year1, String address, long size, int W, int H) {
        ...
        this.size = size;
        this.dimention = new Dimention(W, H);
