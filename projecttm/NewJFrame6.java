...
public class NewJFrame6 extends javax.swing.JFrame {
     ...
     */
    public NewJFrame6() {
        DataFormats df = DataFormats._mp3;
        String[] namespace = df.getFormats("Audio",14);
    ...
    public void setTexts(String format, String name, String des, String cDate, String mDate, String size, String duration, String artist, String address ){
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        Audio audio = new Audio(jComboBox1.getSelectedItem().toString(), jTextField1.getText(), jTextField2.getText(), Integer.parseInt(jTextField6.getText()),Integer.parseInt(jTextField5.getText()),Integer.parseInt(jTextField4.getText()), Integer.parseInt(jTextField9.getText()),Integer.parseInt(jTextField8.getText()),Integer.parseInt(jTextField7.getText()), jTextField3.getText(), Integer.parseInt(jTextField10.getText()), Integer.parseInt(jTextField13.getText()), jTextField14.getText());
        
        Filer.myfile.format(DB);
        
        String name =  audio.name.replaceAll(" ", "_");
        String description = audio.description.replaceAll(" ", "_");
        String address = audio.address.toString().replaceAll(" ", "_");
        String artist = audio.Artist.toString().replaceAll(" ", "_");
        
        Filer.Write(audio.format.toString(), name, description, audio.cDate, audio.mDate, audio.size, String.format("%s",audio.duration), artist, address, " ");
        Filer.Close();
