...
public class NewJFrame7 extends javax.swing.JFrame {
     ...
     */
    public NewJFrame7() {
        DataFormats df = DataFormats._flv;
        String[] namespace = df.getFormats("Video",24);
    ...
    private void initComponents() {
        ...
        jTextField7.setForeground(new java.awt.Color(255, 153, 153));
        ...
        jTextField9.setForeground(new java.awt.Color(255, 153, 153));
    ...
    public void setTexts(String format, String name, String des, String cDate, String mDate, String size, String duration, String genre, String fRate, String address ){
        ...
        jTextField13.setText(duration);
        jTextField14.setText(genre);
        jTextField15.setText(fRate);
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        Video video = new Video(jComboBox1.getSelectedItem().toString(), jTextField1.getText(), jTextField2.getText(), Integer.parseInt(jTextField6.getText()),Integer.parseInt(jTextField5.getText()),Integer.parseInt(jTextField4.getText()), Integer.parseInt(jTextField9.getText()),Integer.parseInt(jTextField8.getText()),Integer.parseInt(jTextField7.getText()), jTextField3.getText(), Integer.parseInt(jTextField10.getText()), Integer.parseInt(jTextField13.getText()), jTextField14.getText(),  Integer.parseInt(jTextField15.getText()));
        Filer.myfile.format(DB);
        
        String name =  video.name.replaceAll(" ", "_");
        String description = video.description.replaceAll(" ", "_");
        String address = video.address.toString().replaceAll(" ", "_");
        String genre = video.genre.toString().replaceAll(" ", "_");
        
        Filer.Write(video.format.toString(), name, description, video.cDate, video.mDate, video.size, String.format("%s",video.duration), genre,String.format("%s",video.fRate), address);
        Filer.Close();
